...
\begin{center}
$\begin{array}{cc}
\includegraphics[width=0.45\textwidth]{./figures/dataPreExpanded.png}&
\includegraphics[width=0.45\textwidth]{./figures/dataExpanded.png}\\
(a)&(b)
\end{array}$
\end{center}
...
\begin{center}
\fbox{
\includegraphics[width=0.45\textwidth]{./figures/joinTextures.png}
}
\end{center}
