...
Tree1::Tree1(TextureManager *texManager, ShaderManager *shManager):
...
{
	// shader
	shaderId = shaderManager->loadShader("Tree1", TREE1_VS_FILENAME, TREE1_FS_FILENAME);
	...
	// textury
	textureId = textureManager->loadTexture(TREE1_TEX_NAME, "tree1_tex", 0, false);
...
Vegetation* Tree1::getCopy()
{
	Tree1 * copy = new Tree1(this);
	return copy;
}
...
void Tree1::fixTexType()
{
}

v3	 Tree1::transformTexCoords(v3 &origTexCoords)
{
